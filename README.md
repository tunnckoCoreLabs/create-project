# @tunnckocore/create-project [![npm version][npmv-img]][npmv-url] [![github release][ghrelease-img]][ghrelease-url] [![License][license-img]][license-url]
...
```bash
$ yarn add @tunnckocore/create-project
```
...
[Become a Partner or Sponsor?][patreon-url] :dollar: Check the **Partner**, **Sponsor** or **Omega-level** tiers! :tada: You can get your company logo, link & name on this file. It's also rendered on package page in [npmjs.com][npmv-url] and [yarnpkg.com](https://yarnpkg.com/en/package/@tunnckocore/create-project) sites too! :rocket:
...
_This file was generated by [verb-generate-readme](https://github.com/verbose/verb-generate-readme), v0.8.0, on November 03, 2018._

<!-- Heading badges -->

[npmv-url]: https://www.npmjs.com/package/@tunnckocore/create-project
[npmv-img]: https://badgen.net/npm/v/@tunnckocore/create-project?icon=npm
...
[license-img]: https://badgen.net/npm/license/@tunnckocore/create-project
...
[downloads-weekly-img]: https://badgen.net/npm/dw/@tunnckocore/create-project
[downloads-monthly-img]: https://badgen.net/npm/dm/@tunnckocore/create-project
[downloads-total-img]: https://badgen.net/npm/dt/@tunnckocore/create-project
